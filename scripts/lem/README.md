...
Script séance 600D : [`essais-2026/seance-600d-t150.txt`](essais-2026/seance-600d-t150.txt). 100D : [`seance-100d-w24.txt`](essais-2026/seance-100d-w24.txt). Dual : [`seance-2apn-interlace.txt`](essais-2026/seance-2apn-interlace.txt) ([DEC-019](../../docs/decisions.md)). Recette [DEC-013](../../docs/decisions.md)–[DEC-016](../../docs/decisions.md) : rampe 7 / étendue 9, ISO **100 / 200 / 800**, **taux Lune**, `COMMAND ;say` **courts à ~1 s** ([KI-021](../../docs/known-issues.md) ; leçon SEM : un message long reste muet).
